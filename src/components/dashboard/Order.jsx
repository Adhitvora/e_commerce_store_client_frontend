      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <div className="text-slate-600">
          ...
          <p>
            Pyment status:{" "}
            <span
              className={`py-[1px] text-xs px-3 ${myOrder.payment_status === "paid" ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"} rounded-md `}
            >
          ...
          <p>
            Order status:{" "}
            <span
              className={`py-[1px] text-xs px-3 ${myOrder.delivery_status === "paid" ? "bg-indigo-100 text-indigo-800" : "bg-red-100 text-red-800"} rounded-md `}
            >
